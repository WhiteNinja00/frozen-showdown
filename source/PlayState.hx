...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['I Feel Bad For You', 0.2], //From 0% to 19%
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("bfb.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("bfb.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	public function updateScore(miss:Bool = false)
	{
		var thing = 0.0;
		if(2 < 1) {
			thing = Math.floor(ratingPercent * 100);
		} else {
			var tempMult:Float = 1;
			for (i in 0...2) {
				tempMult *= 10;
			}
			var newValue:Float = Math.floor(ratingPercent * 100 * tempMult);
			thing = newValue / tempMult;
		}

		scoreTxt.text = 'Score: ' + songScore
		+ ' | Misses: ' + songMisses
		+ ' | Rating: ' + ratingName
		+ (ratingName != '?' ? ' (${thing}%) - $ratingFC' : '');
