...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		changeModeText.setFormat(Paths.font("bfb.ttf"), 32, FlxColor.WHITE, CENTER);
	...
	function createTexts()
	{
		for (i in 0...4)
		{
			...
			text.setFormat(Paths.font("bfb.ttf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
