...
class CharacterEditorState extends MusicBeatState
{
	...
	override function create()
	{
		...
		textAnim.setFormat(Paths.font("bfb.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		for (i in 0...tipTextArray.length-1)
		{
			...
			tipText.setFormat(Paths.font("bfb.ttf"), 12, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK);
	...
	function reloadBGs() {
		...
		if(onPixelBG) {
			...
			var bglol:FlxSprite = new FlxSprite(0, 0).makeGraphic(FlxG.width, FlxG.height, 0xFFFFFFFF);
			bgLayer.add(bglol);
	...
	function genBoyOffsets():Void
	{
		...
		for (anim => offsets in char.animOffsets)
		{
			...
			text.setFormat(Paths.font("bfb.ttf"), 16, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
